...
import { ImageGalleryWithLinksModel } from '../../models/global-fields/image-gallery-with-links-model';


export default function ImageGallery({ bannerProps }: { bannerProps: ImageGalleryWithLinksModel }) {
    return (      
